---
title: Claude Code保姆级教程-转载自秋芝2046
date: 2026-05-10
updated: 2026-05-10
categories: [AI]
tags: [Claude Code, 教程, 转载]
comments: true
---

本文来源于网络，作者：秋芝2046，仅作学习交流分享，不用于商业用途。版权归原作者所有，若有侵权，即刻删除
原文章链接：[Claude Code完全教程【视频文档】 - 飞书云文档](https://my.feishu.cn/wiki/Takxwov60iO5OOkOmpEcpOGynac)
 很优秀的 UP 主，内容做得非常用心、质量超高，祝愿往后创作之路越来越好！
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_18.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_29.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_30.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_33.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_35.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_06.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_23.png)

**步骤2：**安装完成后，**务必在打开Claude Code之前**，优先设置CC Switch。在CC Switch的Claude Code页面添加API Key供应商：

![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_14.png)

**步骤3：**以 **Minimax** 为例，选择对应厂商（中国版），然后填写API Key和Base URL：

![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_07.png)![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_11.png)

> - 如果不知道Base URL，可以在API Key的官方文档里找到（以[Minimax的官方文档](https://platform.minimaxi.com/docs/guides/models-intro)为例）
> 
> ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_31.png)

**步骤4：**选择「启用」设置好的API，CC的大模型配置完成！下一步可以准备打开Claude Code了：

![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_03.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_10.png)![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_25.png)


**步骤2：**根据个人喜好设置皮肤与主题，然后一路 `yes` 后，进入CC主界面：

![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_27.png)

**步骤3：**默认情况下，CC接到任务后会进入 **计划模式（Plan Mode）**：

![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_28.png)
...
2. CC在Accept Edits模式下，执行终端命令时，下图三个选项的含义依次分别是：
    ...
    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_04.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_09.png)
...
- 输入`/context`命令，它会详细的展示我们的上下文占比信息：
    ...
    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_05.png)
...
- 对CC输入提示词，并根据CC引导完成后重启终端即可：
    ...
    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_08.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_24.png)
...
- 打开Auto Memory：输入`/memory` ，选择「**Auto-memory**」并输入回车开启
    ...
    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_15.png)
...
2. **skill合集网站：****[lobehub](https://lobehub.com/zh/skills)**
    ...
    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_26.png)
...
4. **下载了skill怎么装？**
    ...
    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_22.png)
...
2. **手动创建：**通过指令 `/agents` ，在Library界面进行创建
    ...
    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_16.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_32.png)

**步骤2：**选择「AI辅助创建」，让AI根据意图辅助创建

![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_36.png)

**步骤3：**描述想要的子Agent功能

![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_20.png)

**步骤4：**决定子Agent工具权限（✓为选中）

![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_13.png)

**步骤5：**选择Claude的模型

- 一般选Sonnet就可以（如果使用CC Switch配置了模型，选哪个都一样）

    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_01.png)
...
- 选个好看的颜色
    ...
    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_34.png)
...
- 输入 `/agents`，在Library下选择已创建的项目级子Agent
    ...
    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_21.png)

- 根据需求对子Agent进行相应操作

    ![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_02.png)
...
![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_17.png)

**步骤2：**在插件管理界面，可以收录下载钟意的插件，或管理已下载插件

![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_12.png)![](https://abstrac1on-1316638019.cos.ap-guangzhou.myqcloud.com/Claude_dir/img_19.png)
